namespace NorthwindAdmin
{
    partial class FrmClientes
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewCellStyle2.BackColor = Color.FromArgb(25, 25, 111);
            dataGridViewCellStyle2.Font = new Font("Nirmala UI", 10F);
            dataGridViewCellStyle2.ForeColor = Color.White;
            dgvClientes.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            dataGridViewCellStyle3.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dataGridViewCellStyle3.BackColor = Color.White;
            dataGridViewCellStyle3.Font = new Font("Nirmala UI", 10F);
            dataGridViewCellStyle3.ForeColor = Color.FromArgb(47, 79, 79);
            ...
            dataGridViewCellStyle5.BackColor = Color.FromArgb(25, 25, 111);
            dataGridViewCellStyle5.Font = new Font("Nirmala UI", 10F);
            dataGridViewCellStyle5.ForeColor = Color.White;
            dgvPedidos.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
            dataGridViewCellStyle6.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dataGridViewCellStyle6.BackColor = Color.White;
            dataGridViewCellStyle6.Font = new Font("Nirmala UI", 10F);
            dataGridViewCellStyle6.ForeColor = Color.FromArgb(47, 79, 79);
